...
const FiltrosAlumnos = ({ onFilterChange, showFilters, setShowFilters }) => {
    ...
    const fetchProvincias = async (paisNombre) => {
        try {
            setLoadingProvincias(true);
            setProvincias([]);
            setFiltroProvincia('');
            
            // Encontrar el país seleccionado para obtener su ID
    ...
    const handlePaisChange = (e) => {
        const selectedPaisNombre = e.target.value;
        setFiltroPais(selectedPaisNombre);
        setFiltroProvincia('');
        
        if (selectedPaisNombre) {
            fetchProvincias(selectedPaisNombre);
        } else {
            setProvincias([]);
        }
    };
                ...
                <Form>
                    ...
                    <Form.Group controlId="filtroProvincia" className="mt-3">
                        ...
                        <Form.Select 
                            ...
                            disabled={!filtroPais || loadingProvincias}
                        >
